...
2. **AI Persona Expansion:** 
   ...
   - *Example:* A "Low Tech, 50 y/o" persona becomes: *"You are Bob, 50. You get easily frustrated by hidden menus and small text. You prefer clear, large buttons. If you can't find pricing within 2 minutes, you will leave."*
...
1. **Inner Monologue/Thoughts:** *"I see the homepage. I'm looking for pricing, but it's hidden behind a hamburger menu. This is slightly annoying."*
...
- **Executive Summary:** Highlighting the most common friction points (e.g., *"60% of personas over age 40 failed to find the signup button due to low contrast."*)
