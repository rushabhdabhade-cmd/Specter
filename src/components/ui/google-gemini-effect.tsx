...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("relative w-full h-full", className)}>
      {/* Button centered at the convergence point of the lines */}
      {/* SVG convergence is at x=50%, y≈500 of 890px SVG. SVG top = -160px.
          So convergence y from div top = -160 + 500 = 340px ≈ 38% of screen height */}
      {/* Button is rendered inside the SVG via foreignObject at exact convergence coords (720, 514) */}
      ...
      >
        ...
        {/* Sharp layer — crisp colored lines on top */}
        {paths.map((p, i) => (
          <motion.path
            key={`line-${i}`}
            d={p.d}
