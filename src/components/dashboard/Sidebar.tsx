  ...
  return (
    <div className="hidden md:flex h-screen w-72 flex-col border-r border-white/5 bg-[#050505] text-slate-400 relative z-[60]">
      ...
      <div className="flex h-24 items-center gap-4 px-8 border-b border-white/5">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 shadow-2xl transition-transform hover:scale-110 active:scale-95">
          <Ghost className="h-5 w-5 text-white" />
        </div>
        <div className="flex flex-col">
          <span className="text-lg font-black tracking-tight text-white uppercase">Specter</span>
          <span className="text-[9px] font-black tracking-[0.2em] text-indigo-500 uppercase">Engine v1.4</span>
        </div>
      </div>
      ...
      <nav className="flex-1 space-y-8 px-6 py-10 overflow-y-auto scrollbar-hide">
        ...
        <div className="space-y-4 pt-4 border-t border-white/5">
          <h4 className="px-2 text-[10px] font-black uppercase tracking-[0.3em] text-slate-700">System</h4>
          <Link href="/settings" className="flex items-center gap-4 px-4 py-2 text-[11px] font-black uppercase tracking-widest text-slate-600 hover:text-white transition-colors group">
            <Settings className="h-4 w-4 opacity-50 group-hover:opacity-100" />
            Preferences
          </Link>
          <Link href="/database" className="flex items-center gap-4 px-4 py-2 text-[11px] font-black uppercase tracking-widest text-slate-600 hover:text-white transition-colors group">
